...
-- NOTE: on some deployments this version number (005) may already be marked
-- applied from an earlier draft that had different SQL here, so this file can
-- end up skipped. See 007_facebook_post_targets_fix.sql, which re-applies the
-- same CREATE TABLE under a version number that has never been used before,
-- so the table is guaranteed to exist either way.
